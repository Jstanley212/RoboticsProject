/*
	Program:The robot follows a black line until it detects an obstacle
	Authors: Jack McCarthy, Joshua Stanley, Jan Varbe
	Date:28/02/2024
*/
	    ...
	    while (true)
	      {
	            ...
	            while (SensorValue(sonarSensor) <15)
	            {
	            	...
	            	while (SensorValue(colourSensor)>=average)
	            		...
	            		setMotorSync(rightMotor, leftMotor, 35, 45);
	            		}
	      			}
